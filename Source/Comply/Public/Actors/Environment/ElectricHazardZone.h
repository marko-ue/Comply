...
private:
    ...
    TMap<TWeakObjectPtr<AActor>, FActiveGameplayEffectHandle> ActiveStunEffectHandles;
    ...
    void ApplyStunToTarget(AActor* OverlappingActor, UAbilitySystemComponent* TargetASC);
